...
import { Menu, Bell, Search, LogOut, ShoppingCart, GraduationCap, Heart, ChevronDown, X, Check, AlertTriangle, Info, AlertCircle } from "lucide-react";
    ...
    <header style={{ backgroundColor: 'var(--card-bg)', borderColor: 'var(--border-color)' }} className="border-b px-4 sm:px-6 py-3">
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-400 to-purple-500 flex items-center justify-center cursor-pointer hover:scale-105 transition-transform">
